...
<html>
    ...
    <body>
        ...
        <div class="section-bg-1">
            <div class="container">
                <form class="needs-validation " novalidate action="/payment/edit" object="${cs}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <select id="major" name="major" value="${major}" class="form-control input-sm" required>
                                            <option value="" selected  >khoản chi</option>
                                            <option value="chi tiền lương">chi tiền lương</option>
                                            <option value="chi tiền khác" >Chi tiền điện</option>
                                            <option value="chi tiền nước">Chi tiền nước</option>
                                            <option value="chi khac">Chi khác...</option>
                                        </select>
                                        <div class="valid-feedback">hợp lệ</div>
